...
const Review = () => {
  return (
    <div style={{display:'flex', flexDirection:'column',gap:'1rem'}}>
        <div style={{display:'flex',alignItems:'center', gap:'1rem'}}><UsersComponent image={user1} style={{width:'2rem', height:'2rem'}}/> <Body4 color={'#212121'}>{"Danish Shah"}</Body4><Body3 color={'#8A8894'}>{"1d ago"}</Body3></div>
