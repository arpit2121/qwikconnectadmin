    ...
    <Box sx={{ width: '100%', typography: 'body1'}}>
       {
        responsive.isMobile
        ?
        <Box sx={{width:'100%', height:'60px',backgroundColor:'',display:'flex'}}>
        ...
        :
        <Box sx={{height:'40px', backgroundColor:'', paddingTop:'20px', paddingBottom:'20px',display:'flex',justifyContent:'space-between'}}>
      ...
      <TabContext value={value}>
        ...
        //   allowScrollButtonsMobile
          ...
          >
            <StyledTab label="Basic Details" value="1" component={Link} to={'/jobposting/basicDaetails'}/>
            <StyledTab label="Question Setup" value="2" component={Link} to={'/jobposting/questionSetup'}/>
            <StyledTab label="Branding" value="3" component={Link} to={'/jobposting/Branding'}/>
            <StyledTab label="Publish link" value="4" component={Link} to={'/jobposting/PublicLink'}/>
          </TabList>
        </Box>
        <StyleTabPanel value="1"><JobPostingStepFourB/></StyleTabPanel>
        <StyleTabPanel value="2"><JobPostingStepTwo/></StyleTabPanel>
        <StyleTabPanel value="3"><JobPostingStepThree/></StyleTabPanel>
        <StyleTabPanel value="4"><JobPostingStepFourA/></StyleTabPanel>
      </TabContext>
      <div style={{marginTop:'5rem', paddingBottom:'5rem',display:'flex',justifyContent:'flex-end',gap:'2rem'}}>
